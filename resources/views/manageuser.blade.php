...
<div class="main-content">
    ...
    {{-- ===================== ADD USER FORM ===================== --}}
    <form method="POST" action="/manage-user" enctype="multipart/form-data">
        @csrf
        <div class="card">
...
<div id="deletePopup" class="popup-overlay" style="display:none;">
    <div class="popup-box">
        ...
        <div class="popup-actions">
            <button onclick="closeDeletePopup()" class="popup-btn cancel">Cancel</button>
            <button onclick="submitDelete()" class="popup-btn danger">
...
<div id="editModal" class="popup-overlay" style="display:none;">
    <div class="popup-box edit-popup-box">

        <p style="font-size:18px; font-weight:700; margin-bottom:20px;">Edit User</p>
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group signature-upload" style="margin-bottom:20px; text-align:left;">
                <label>Upload Signature</label>
            ...
            <div style="display:flex; gap:12px; margin-top:10px; justify-content:center;">
                ...
                <button type="button" onclick="closeEditModal()" class="add-btn btn-cancel">
                    Cancel
                </button>
            </div>
        </form>
